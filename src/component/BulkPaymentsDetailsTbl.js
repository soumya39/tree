...
const getBulkPaymentFromServer = ()=>{axios.get(`http://localhost:3001/exception/queue/indivisualpayments/list`)
.then((response)=>{
    console.log('loading....')
...
useEffect(()=>{
    ...
    {/*         <div style={{ marginLeft: 10 }}>
                <GlobalFiltering filter={globalFilter} setFilter={setGlobalFilter} style={{ marginLeft: '10' }} /></div> */}
            <Table size='sm' striped={false} striped={true} style={{ marginTop: 5, }} {...getTableProps()}>
...
export default BulkPaymentsDetailsTbl
