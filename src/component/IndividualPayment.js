...
useEffect(()=>{
    ...
    return (
        <div>
            ...
            <Table responsive='true' size='sm' striped={false} striped={true} style={{ marginTop: 20,}} {...getTableProps()}>
                <thead style={{backgroundColor:'#254a9e', color:'white',bordercolor:'#254a9e', fontSize:14, fontWeight :'bold' }} >
                    {
